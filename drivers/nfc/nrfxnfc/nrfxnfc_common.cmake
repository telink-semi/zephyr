...
# Usage:
#   nrfxnfc_calculate_lib_path(<dir> [SOC_MODE] [BASE_DIR <dir> [SOFT_FLOAT_FALLBACK]])
#
...
#
function(nrfxnfc_calculate_lib_path lib_path)
    ...
    if(CALC_LIB_PATH_SOFT_FLOAT_FALLBACK AND NOT DEFINED CALC_LIB_PATH_BASE_DIR)
        message(WARNING "nrfxnfc_calculate_lib_path(SOFT_FLOAT_FALLBACK ...) "
